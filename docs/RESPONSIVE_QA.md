...
| Explore       | KNOWN DEVIATION | Responsive search/filter/card structure passes. Truthful “Worth trying” and store content replace unsupported collections/rankings.                                                                                                                     |
